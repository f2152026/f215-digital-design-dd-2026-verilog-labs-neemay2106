...
module ripple_adder(
  ...
  FA_Gate dut1(.a(a[0]),.b(b[0]),.cin(cin),.sum(sum[0]),.cout(c1));
  FA_Gate dut2(.a(a[1]),.b(b[1]),.cin(c1),.sum(sum[1]),.cout(c2));
  FA_Gate dut3(.a(a[2]),.b(b[2]),.cin(c2),.sum(sum[2]),.cout(c3));
  FA_Gate dut4(.a(a[3]),.b(b[3]),.cin(c3),.sum(sum[3]),.cout(cout));
